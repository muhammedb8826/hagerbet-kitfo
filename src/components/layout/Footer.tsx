...
export default function Footer() {
  return (
    <footer className="pb-6 bg-neutral-900 pt-section">
      <div className="container container--sm">
        <div className="max-w-screen-xl mx-auto text-center">
          <a
            href="#"
            className="flex items-center justify-center text-2xl font-semibold text-neutral-900 dark:text-white"
          >
            <svg
              className="h-8 mr-2"
              viewBox="0 0 33 33"
          ...
          <p className="my-6 text-neutral-500 dark:text-neutral-400">
            Open-source library of over 400+ web components and interactive
            elements built for better web.
          </p>
          <ul className="flex flex-wrap items-center justify-center mb-6 text-neutral-900 dark:text-white">
            <li>
